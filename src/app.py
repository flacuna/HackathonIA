...
from presentation.estrategico_router import router as estrategico_router
from presentation.dashboard_router import router as dashboard_router
...
app.include_router(estrategico_router, prefix="/api")
